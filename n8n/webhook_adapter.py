#!/usr/bin/env python3
"""
Standalone Microservice Webhook Adapter for sovereign-venture-underwriting
Listens on port 8795 and translates n8n requests into deterministic engine executions.
"""
import sys
import os
import json
...
def run():
    server = HTTPServer(("0.0.0.0", 8795), WebhookHandler)
    print(f"[Sovereign Venture Underwriting] Webhook Adapter listening on http://0.0.0.0:8795")
